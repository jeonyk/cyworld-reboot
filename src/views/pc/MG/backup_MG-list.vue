          ...
          <GuestBook>
            <div class="items depth1">
              ...
              <div class="function">
                ...
                <Button color="cy_blue" text value="댓글 1개" class="btn_comment" @click="expand = !expand"></Button>
              </div>
            </div>
            <v-expand-transition>
          ...
          <GuestBook>
            <div class="items depth1">
              ...
              <div class="function">
                ...
                <Button color="cy_blue" text value="댓글 2개" class="btn_comment" @click="expand2 = !expand2"></Button>
              </div>
            </div>
            <v-expand-transition>
          ...
          <GuestBook>
            <div class="items depth1">
              ...
              <div class="function">
                ...
                <Button color="cy_blue" text value="댓글 3개" class="btn_comment" @click="expand3 = !expand3"></Button>
              </div>
            </div>
            <v-expand-transition>
