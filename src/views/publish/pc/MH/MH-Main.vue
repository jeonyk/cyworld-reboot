...
<!--              <li><IconButton class="ico_setting cy_gray&#45;&#45;text" large /></li>-->
              <li v-if="did"><IconButton class="ico_favorite mh cy_gray--text" large /></li>
              <li v-if="did && !monihomepyProfile.isFriend"><IconButton class="ico_add mh cy_gray--text" large /></li>
              <li>
                <v-menu
                  offset-y
                  left
                ...
                >
                  ...
                  <ListMore class="mh_setting">
                    <template v-slot:items>
                      <ListMoreDesc primary="일촌 해지" v-if="did && monihomepyProfile.isFriend"/>
                      <ListMoreDesc primary="일촌명 변경" v-if="did && monihomepyProfile.isFriend"/>
                      <ListMoreDesc primary="차단하기" v-if="did"/>
        ...
        <Section mt="12" pb="32">
          ...
          <ListFriendsSay v-if="friendSayList.elements">
            <li>
    ...
    <Alert cardClass="giftselect" :open="pic_upload_popup" max-width="450">
      <template v-slot:dialog-title>
        <v-card-title>프로필 사진 <ProfileCount>1/999</ProfileCount>
          ...
          <!-- // 2021.12.01 프로필 사진 레이어 팝업 더보기 버튼 삭제 -->
          <!-- <v-menu
              offset-y
              left
              transition="slide-y-transition"
