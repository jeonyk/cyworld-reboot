  ...
  <Wrap>
    ...
    <Alert cardClass="giftselect" :open="pic_upload_popup" max-width="450">
      ...
      <template v-slot:dialog-text>
        <v-card-text>
          <ProfileUploadForm class="profile-already">      
            <input type="file">
            <img src="/img/temp_profile.png" alt="">
            <p>변경할 사진을 드래그하여 첨부해주세요</p>
          </ProfileUploadForm>
          <Button value="사진 업로드" block large mb="10"></Button>
          <Button value="기본 이미지로 설정" block large outlined mb="10"></Button>
          <Button value="사진 삭제" block large outlined></Button>
        </v-card-text>
      </template>
    </Alert>
