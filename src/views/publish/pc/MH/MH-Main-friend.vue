  ...
  <Wrap>
    ...
    <Container>
      ...
      <Main>
        <Section pb="20">
          <MhTitle>
            <H2 class="title_page mh-title">조은이의 미니홈피, 방문환영!!!</H2>
            <MhSetting>
              <li><IconButton class="ico_favorite mh cy_gray--text" large /></li>
              <li>
                <v-menu 
                  offset-y
                  left
                ...
                >
                  ...
                  <ListMore class="mh_setting">
                    <template v-slot:items>
                      ...
                      <ListMoreDesc primary="차단하기" />
                      <ListMoreDesc primary="신고하기" />
                      <!-- // 2021.12.01 미니홈피 상단 더보기 메뉴 문구 수정 -->
                      <ListMoreDesc primary="카카오톡 공유" class="invite_kakao" />
          ...
          <MyToday>
            ...
            <MyTodayInfo>
              ...
              <TodayDesc>
                ↘━↙↘━↙↘━↙↘━↙↘━↙↘↘━↙↘━↙↘━↙↘━↙↘━↙↘↘━↙↘━↙↘━<br>
                ┃보┃ ┃고┃┃싶┃┃어┃┃요┃┃보┃ ┃고┃┃싶┃┃어┃┃요┃┃보┃ ┃고┃<br>
                ↗━↖↗━↖↗━↖↗━↖↗━↖↗↗━↖↗━↖↗━↖↗━↖↗━↖↗↗━↖↗━↖↗━<br>
                ┃너┃┃무┃┃사┃┃랑┃┃해┃┃너┃┃무┃┃사┃┃랑┃┃해┃┃너┃┃무┃<br>┃
                。'ㅇ'☆'。*。*.。'☆*。。'ㅇ.☆.。'.。'ㅇ'☆'。*。*.。'☆*。。'ㅇ.☆.。'.。'ㅇ'☆'。*。*.
              </TodayDesc>
            </MyTodayInfo>
          </MyToday>
        ...
        <Section mt="12" pb="32">
          <H2 class="title_page mh-title fs">What Friends Say</H2> <!-- // 2021.12.01 noline 클래스 제거 -->
          <!-- // 2021.12.01 일촌평 쓰기 기능 제외 -->
          <!-- <WriteFriendsSay>
...
import Friends from '@/views/publish/pc/aside/Friends.vue';
