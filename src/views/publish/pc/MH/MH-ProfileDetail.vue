  ...
  <Wrap>
    ...
    <Alert cardClass="giftselect" :open="pic_upload_popup" max-width="450">
      <template v-slot:dialog-title>
        <v-card-title>프로필 사진 <ProfileCount>1/2</ProfileCount>
      ...
      <template v-slot:dialog-text>
        <v-card-text>
          <ProfileUploadModify> 
            <img src="/img/temp_profile_default_3x.png" alt="" class="profile">
          </ProfileUploadModify>
          <ProfileUploadList pl="15">
            <ProfileUploadItem class="active selected">
              <img src="/img/temp_profile_default_3x.png" alt="" class="profile">
            </ProfileUploadItem>
            <ProfileUploadItem>
              <img src="/img/temp_profile.png" alt="" class="profile">
            </ProfileUploadItem>
            <ProfileUploadItem class="blank"></ProfileUploadItem>
            <ProfileUploadItem class="blank"></ProfileUploadItem>
          </ProfileUploadList>
        </v-card-text>
      </template>
