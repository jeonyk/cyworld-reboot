            ...
            <template v-slot:v-tab-item>
              <v-tab-item transition="false">
                <InputText
                  ...
                  solo
                  class="input_search gift"
                /> 
                  <ListFriendsGift pb="378">
                  <h4>검색 결과</h4>
                    <li>
                      <p class="thumb"><img src="/img/temp_profile.png" alt=""></p>
                      <p class="link_text">
                        <span>코끼리</span>
                        <span class="nickname">코가손이래</span>
                      </p>
                      <p class="friend_gift">
                        <Button value="선물하기" class="btn_gift" outlined></Button>
                      </p>
                    </li>
                    <li>
                      <p class="thumb"><img src="/img/temp_profile.png" alt=""></p>
                      <p class="link_text">
                        <span>따뜻한날에는</span>
                        <span class="nickname">코코아한잔어떠세요</span>
                      </p>
                      <p class="friend_gift">
                        <Button value="선물하기" class="btn_gift" outlined></Button>
                      </p>
              ...
              <v-tab-item transition="false">
                <AcornHistoryList>
                  <li>
                    <i class="gift"></i>
                    <span>김토토로어쩌구</span>
                    <span class="nickname">도토리 선물</span>
                    2021.11.01
                    <router-link to="/">  
                      100개
                    </router-link>
