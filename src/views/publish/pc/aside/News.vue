  ...
  <News>
    ...
    <ListNews  class="overflow-y-auto">
      ...
      <li>
        <span class="thumb"><img src="/img/temp_profile.png" alt=""></span>
        <div>
          <p class="desc"><span>대기대기박대기</span>님이 일촌 신청을 기다리고 있어요.</p>
        </div>
      </li>
      <li>
        <span class="thumb"><img src="/img/temp_profile.png" alt=""></span>
        <div>
          <p class="desc"><span>호호홍</span>님이 <span>악소리나는 등산</span> 공유다이어리에 신청했어요.</p>
        </div>
      </li>
      <li>
        <span class="thumb"><img src="/img/temp_profile.png" alt=""></span>
      ...
      <li>
        <span class="thumb"><img src="/img/temp_profile.png" alt=""></span>
        <div>
          <p class="desc"><span>노랑이조아</span>님이 <span>노란세상</span> 공유다이어리에 신청했어요.</p>
        </div>
      </li>
      <li>
        <span class="thumb"><img src="/img/temp_profile.png" alt=""></span>
