<template>
  <div>
    <div style="position:absolute;top:60px;padding-left:50px;">읽기 전</div>
    <Header style="position: absolute; top:100px">
      <Inner class="inner">
        <H1><router-link to="/" class="ir">cyworld</router-link></H1>
        <Gnb>
          <TabGnb class="styled_tab gnb">
    ...
    <div style="position:absolute;top:260px;padding-left:50px;">null</div>
          ...
          <ul>
            ...
            <li>
              ...
              >
                ...
                <TabNotice class="styled_tab">
                  <template v-slot:v-tab>
                    <v-tab class=""><span>반가운 소식</span></v-tab>
                    <v-tab class=""><span>초대</span></v-tab>
                    <v-tab class=""><span>일촌 생일</span></v-tab>
                  </template>
                  <template v-slot:v-tab-item>
                    <v-tab-item transition="false">
                      <!-- <h4 class="subtitle">반가운 소식(30)<Button small text value="전체읽음"></Button></h4> -->
      ...
      ul{
        ...
        li{
          ...
          .v-btn{
            ...
            &:hover{
              background-color: rgba(243, 107, 43, 0.04);
            }
            &:active, &:focus{
...
.overflow-y-auto{
  ...
  &::-webkit-scrollbar-thumb { background:  #e5e5e5; border-radius: 10px; } /* 실질적 스크롤 바 */
