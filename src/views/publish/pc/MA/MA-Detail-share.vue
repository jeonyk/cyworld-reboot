    ...
    <Container>
      ...
      <Main>
        ...
        <Section mt="12" pb="0" class="bg_none">
          <AlbumDetail>
            <div class="titlebar">
              <h4>사진첩 제목은 30자까지 입력 허용합니다 (비율 3:2)</h4>
              <v-menu 
                offset-y
                left
            ...
            <router-link to="/" class="original">
              ...
              <span class="desc">나의 미니홈피 명<b class="d-flex flex-column nickname">애국자김씨애국자이씨애국자</b><!-- 님이 작성한 게시물이에요--></span>
            </router-link>
            <div class="function">
          ...
          <AlbumDetail>
            ...
            <router-link to="/" class="original">
              <span class="thumb"><img src="/img/temp_profile.png" alt=""></span>
              <span class="desc">나의 미니홈피 명<b class="d-flex flex-column nickname">바다사랑사랑</b> <!--님이 작성한 게시물이에요--></span>
            </router-link>
            <div class="function">
