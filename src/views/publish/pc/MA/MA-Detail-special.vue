          ...
          <AlbumDetail>
            ...
            <div class="thumb">
              ...
              >
                ...
                <swiper-slide><img src="/img/temp_album.png" alt=""></swiper-slide>
                <swiper-slide><img src="/img/temp_album.png" alt=""></swiper-slide>
                <swiper-slide><img src="/img/temp_album.png" alt=""></swiper-slide>
            ...
            <div class="desc">
              동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세 <router-link to="/" class="notitag">@얍</router-link><br />
              무궁화 삼천리 화려 강산<br /><br />
              ...
              밝은 달은 우리 가슴 <router-link to="/" class="hashtag">#일편단심</router-link> 일세<br /><br />

              무궁화 삼천리 화려 강산<br /><br />

              대한사람 대한으로 길이 보전하세<br /><br />

              이 기상과 이 마음으로 충성을 다하여<router-link to="/" class="notitag">@너굴맨</router-link><br />
              괴로우나 즐거우나 나라사랑하세<br />
              무궁화 삼천리 화려 강산<br />
              대한사람 대한으로 길이 보전하세 <router-link to="/" class="hashtag">#애국가</router-link> <router-link to="/" class="hashtag">#애국심뿜뿜</router-link> <router-link to="/" class="hashtag">#무궁화</router-link>

            </div>
            <div class="date">1일전</div>
            <router-link to="/" class="original">
              <span class="thumb"><img src="/img/temp_profile.png" alt=""></span>
              <span class="desc">무궁화꽃이피었습니다무궁화 <b class="d-flex flex-column nickname">애국자김씨애국자이씨애국자</b><!--님이 작성한 게시물이에요--></span>
            </router-link>
            <div class="function">
