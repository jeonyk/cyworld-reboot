        ...
        <Section mt="12" pb="0" class="bg_none">
          <AlbumDetail>
            ...
            <div class="function">
              ...
              <Button value="댓글" text class="btn_comment">
                <template v-slot:icon-left>
                  <v-icon class="ico_comment" left></v-icon>
                </template>
              </Button>
              <v-spacer></v-spacer>
              <Button value="퍼가요" text class="btn_share">
                <template v-slot:icon-left>
                  <v-icon class="ico_share" left></v-icon>
                </template>
              </Button>
              <p class="count">
                <ul class="lst_thumb">
                ...
                <b class="num">200명</b>이 이 글에 공감하고있어요.
              </p>
            </div>
          </AlbumDetail>
          <AlbumDetail>
            ...
            <div class="function">
              <Button value="공감" text class="btn_like">
                <template v-slot:icon-left>
                  <v-icon class="ico_like" left></v-icon>
                </template>
              </Button>
              ...
              <!-- <p class="count"><b class="num">200명</b>이 이 글에 공감하고있어요.</p> -->
            </div>
          </AlbumDetail>
          <AlbumDetail>
            <div class="titlebar">
            ...
            <div class="desc">
              고양이 랜드에<br />오신걸 환영하오... <router-link to="/" class="btn_more">더보기</router-link>
            </div>
            <div class="date">2일전</div>
            <div class="function">
              <Button value="공감" text class="btn_like">
              ...
              <p class="count">
                <b class="num">2명</b>이 이 글에 공감하고있어요.
              </p>
            </div>
          </AlbumDetail>
        </Section>
          ...
          <ListReply>
            <div class="items depth1">
              ...
              <div class="contents">
                ...
                <Button color="cy_blue" text :value="replyState[2].btnText" class="btn_comment" @click="toggleExpend(replyState[2])"></Button>
              </div>
              <div class="function">
                <v-menu 
                  offset-y
            ...
            <v-expand-transition>
              <v-card v-show="replyState[2].expand" class="mx-auto" elevation="0">
                <div class="items depth2">
                  <div class="thumb">
                    <img src="/img/temp_profile.png" alt="">
                  </div>
          ...
          <ListReply>
            <div class="items depth1">
              ...
              <div class="contents">
                ...
                <Button color="cy_blue" text :value="replyState[3].btnText" class="btn_comment" @click="toggleExpend(replyState[3])"></Button>
              </div>
              <div class="function">
                <v-menu 
                  offset-y
            ...
            <v-expand-transition>
              <v-card v-show="replyState[3].expand" class="mx-auto" elevation="0">
                <div class="items depth2">
                  <div class="thumb">
                    <img src="/img/temp_profile.png" alt="">
                  </div>
          ...
          <ListReply>
            <div class="items depth1">
              ...
              <div class="contents">
                ...
                <Button color="cy_blue" text :value="replyState[4].btnText" class="btn_comment" @click="toggleExpend(replyState[4])"></Button>
              </div>
              <div class="function">
                <v-menu 
                  offset-y
            ...
            <v-expand-transition>
              <v-card v-show="replyState[4].expand" class="mx-auto" elevation="0">
                <div class="items depth2">
                  <div class="thumb">
                    <img src="/img/temp_profile.png" alt="">
                  </div>
